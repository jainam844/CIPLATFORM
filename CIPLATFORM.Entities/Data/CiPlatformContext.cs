...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PCA158\\SQL2017;DataBase=CI-PLATFORM;User ID=sa;Password=Tatva@123;Encrypt=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA4141F2284894");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C347BF13EAC");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A89DF9BF60");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52942D5CD8");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7957687C6368B31");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD0550B4DB31A");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favorite__94E4D8CABA52694B");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7E32C4198");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB2A6F61D93");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A0BC2AB8A");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC8240262E4");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED15875074469");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E8852533E4");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E51720F7D543B");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___827120085A07D416");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5AC5B2EE2F5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__password__3213E83F44672E4B");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA8379A4904D53");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C568A80B0B7");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__044978676D3F0FAB");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C42AC437C");
        ...
        {
            entity.HasKey(e => e.StoryViewId).HasName("PK__story_vi__A2F4803BEEE995A1");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF50686AAA45D4");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370F212716DE");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576BBC099E30");
